...
public class P03_SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Menginisialisasi variabel selesai
        TextView proses = (TextView) findViewById(R.id.splashscreen);
        //Membuat handler dan akan menuju ke P03 jika SplashScreen selesai
        final Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(getApplicationContext(), P03.class));
