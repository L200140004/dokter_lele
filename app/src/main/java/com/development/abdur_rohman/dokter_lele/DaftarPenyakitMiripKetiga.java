...
public class DaftarPenyakitMiripKetiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selesai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent telah_selesai = new Intent(DaftarPenyakitMiripKetiga.this, MainMenu.class);
        ...
        listViewData.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DaftarPenyakitMiripKetiga.this, InfoPenyakitMirip.class);
