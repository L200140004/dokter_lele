            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_benar:
                        ...
                        Intent pertanyaan_selanjutnya = new Intent(G12.this, P05_SplashScreen.class);
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_tidak:
                        ...
                        Intent mengganti_pertanyaan = new Intent(G12.this, DaftarPenyakitMiripKedua.class);
