...
public class G06_1 extends AppCompatActivity {
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_benar:
                        ...
                        Intent pertanyaan_selanjutnya = new Intent(G06_1.this, G01_1.class);
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_tidak:
                        ...
                        Intent mengganti_pertanyaan = new Intent(G06_1.this, G10.class);
