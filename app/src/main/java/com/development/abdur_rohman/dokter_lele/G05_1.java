...
public class G05_1 extends AppCompatActivity {
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_benar:
                        ...
                        Intent pertanyaan_selanjutnya = new Intent(G05_1.this, G09.class);
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_tidak:
                        ...
                        Intent mengganti_pertanyaan = new Intent(G05_1.this, G19.class);
