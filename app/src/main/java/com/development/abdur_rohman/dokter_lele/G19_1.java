...
public class G19_1 extends AppCompatActivity {
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_benar:
                        ...
                        Intent pertanyaan_selanjutnya = new Intent(G19_1.this, G04_2.class);
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.gejala_tidak:
                        ...
                        Intent mengganti_pertanyaan = new Intent(G19_1.this, DaftarPenyakitMiripKedua.class);
